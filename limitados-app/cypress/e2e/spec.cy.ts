...
describe("Criando cenário de teste para site limitados", () => {
  ...
  it("Caso de teste: Criando Grupo com sucesso", () => {
    ...
    cy.get("#nome").type("Grupo teste");
    cy.get("#descricao").type("Descrição do grupo de teste");
  ...
  it("Caso de teste: Deletando Grupo com sucesso", () => {
    ...
    cy.get("#home-body > :nth-child(1)").click();
    cy.get(".mdi-plus").click();
    cy.get("#nome").type("Grupo teste a ser deletado");
    cy.get("#descricao").type("Descrição do Grupo teste a ser deletado");
    ...
    cy.wait(1000);
    cy.get(".text-error > .v-btn__content").click();
    cy.get("p").should(
      "contain.text",
